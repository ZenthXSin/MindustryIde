...
> Source: `/home/zenxsin/cow/源码和示例/Mindustry/core/src/mindustry/content/Bullets.java`

## 源码位置

- 仓库：`mindustry`
- 相对路径：`core/src/mindustry/content/Bullets.java`
- 绝对路径：`/home/zenxsin/cow/源码和示例/Mindustry/core/src/mindustry/content/Bullets.java`
...
此页是文件级知识点。当前静态摘要：`class Bullets`。
